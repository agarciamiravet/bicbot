...
using BIC.Bot.RestService.Models.AccountViewModels;
using BIC.Bot.RestService.Services;
...
using BIC.Bot.RestService.EsternalServices.Bot;
...
namespace BIC.Bot.RestService.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [HttpGet]
        [AllowAnonymous]
        public async Task<IActionResult> Login([FromQuery]string codeaccess, string returnUrl = null)
        {
            if(!string.IsNullOrEmpty(codeaccess))
            {
                TempData["codeaccess"] = codeaccess;
            }
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null, string codeaccess=null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (model.Email.ToLower() == "father@bicbot.com")
                    {
                        newBotLogin.SkypeUserName = "Padre Bic";
                    }

                    if (model.Email.ToLower() == "rebeca@bicbot.com")
                    {
                        newBotLogin.SkypeUserName = "Rebeca Bic";
                    }

                    if (model.Email.ToLower() == "deliverycourier@bicbot.com")
                    {
                        newBotLogin.SkypeUserName = "Transportista BicBot";
                    }
                    ...
                    var botuserDataDto = new BotUserDataDto { BotConversationId = userData.FromID,
        ...
        [HttpGet]
        [AllowAnonymous]
        public IActionResult LoginSucceded()
        {
            return View();
        }
        ...
        private async Task<object> GenerateJwtToken(string email, IdentityUser user)
        {
            ...
            var expires = DateTime.Now.AddMinutes(Convert.ToDouble(180));
